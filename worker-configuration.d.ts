/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: abe2ac8764ebb28b0d8e2998eec41a8f)
// Runtime types generated with workerd@1.20260722.1 2026-07-27 enable_request_signal,nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	RATING_QUEUE: Queue;
	ROOM_WAKEUP_QUEUE: Queue;
	ROOM_COORDINATOR_MODE: "off";
	ROOM_COORDINATOR_PERCENTAGE: "0";
	DATABASE_URL: string;
	BETTER_AUTH_SECRET: string;
	BETTER_AUTH_URL: string;
	LIVE_STREAM_ADMISSION: DurableObjectNamespace<import("./src/worker").LiveStreamAdmissionGate>;
	ROOM_COORDINATOR: DurableObjectNamespace<import("./src/worker").RoomCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "LiveStreamAdmissionGate" | "RoomCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ROOM_COORDINATOR_MODE" | "ROOM_COORDINATOR_PERCENTAGE" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
