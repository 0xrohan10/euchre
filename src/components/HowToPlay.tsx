                ...
                <section className="rule-step">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      deck has 24 cards: 9, 10, jack, queen, king, and ace in each suit. Everyone
                      gets five cards.
                    </p>
                  </div>
                </section>
                <section className="rule-step">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      suit or pass. If everyone passes, players call any other suit. The dealer must
                      call if the choice returns to them.
                    </p>
                  </div>
                </section>
                <section className="rule-step">
