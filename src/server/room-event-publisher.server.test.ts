...
function roomFixture(overrides: Partial<RoomView> = {}): RoomView {
  return {
    ...
    seats: [
      { seat: 0, userId: 'host', name: 'Host', controller: 'human', connected: true },
      { seat: 1, userId: null, name: 'Bot 1', controller: 'bot', connected: false },
      { seat: 2, userId: 'partner', name: 'Partner', controller: 'human', connected: true },
      { seat: 3, userId: null, name: 'Bot 3', controller: 'bot', connected: false },
    ],
    game: null,
    disconnectVote: null,
    rematch: null,
  ...
  it('sends same-version presence changes', () => {
    ...
    const disconnected = roomFixture({
      seats: [
        { seat: 0, userId: 'host', name: 'Host', controller: 'human', connected: true },
        { seat: 1, userId: null, name: 'Bot 1', controller: 'bot', connected: false },
        { seat: 2, userId: 'partner', name: 'Partner', controller: 'human', connected: false },
        { seat: 3, userId: null, name: 'Bot 3', controller: 'bot', connected: false },
      ],
    })
